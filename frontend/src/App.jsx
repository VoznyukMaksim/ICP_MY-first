...
const App = () => {
      ...
      <div id="day-detail">
        ...
        <div className="notes">
          ...
          {notes.length > 0 ? (
            ...
            <p>Нічого поки немає, нумо виправимо.</p>
          )}
        </div>
        ...
        {!isPastDay && (
          <div className="add-note">
            <input
              type="text"
              id="new-note"
              placeholder="Введіть нотатку: наприклад національне свято"
  ...
  return (
    <div id="root">
      ...
      <div id="calendar">
        <h2>
          {currentDate.toLocaleString('uk-UK', {
            month: 'long',
            year: 'numeric'
          })}
        </h2>
